...
@section('content')
    <div class="brz brz-root__container brz-reset-all brz-root__container-page">
        ...
        <section id="k3F9_bmAlFcS_k3F9_bmAlFcS" class="brz-section brz-css-10iw3y9 brz-css-1l4kisw">
            <div class="brz-section__content brz-section--boxed brz-css-x1vhbq brz-css-nz2cer"
                 data-brz-custom-id="kX2BMyOeX6Q3">
                <div class="brz-bg">
                    <div class="brz-bg-color"></div>
                    <div class="brz-bg-shape brz-bg-shape__top"></div>
                    <div class="brz-bg-shape brz-bg-shape__bottom"></div>
                </div>
                <div class="brz-container brz-css-2lwv1h brz-css-u278c1">
                    <div id="" class="brz-css-naat8z brz-css-1q67fvx brz-wrapper">
                        <div class="brz-rich-text brz-rich-text__custom brz-css-xdn04a brz-css-6y9gup"
                             data-brz-custom-id="sFcuWytJgRw8">
                    ...
                    <div id="" class="brz-css-naat8z brz-css-18c9x2e brz-wrapper">
                        <div class="brz-rich-text brz-rich-text__custom brz-css-xdn04a brz-css-1fhgnz3"
                             data-brz-custom-id="rDqJF49jzkDU">
                            <div data-brz-translate-text="1">
                                ...
                                <p class="brz-fss-lg-px brz-fw-lg-400 brz-ls-lg-0 brz-lh-lg-1_9 brz-vfw-lg-400 brz-fwdth-lg-100 brz-fsft-lg-0 brz-text-lg-center brz-tp-lg-empty brz-ff-overpass brz-ft-google brz-fs-lg-17 brz-css-ely_p"
                                   data-generated-css="brz-css-d8WCh" data-uniq-id="sPCWd">
        ...
        <section id="tuud1Wd07z5e_tuud1Wd07z5e" class="brz-section brz-css-1b3z3in brz-css-124gpei">
            <div class="brz-section__content brz-section--fullWidth brz-css-850zcw brz-css-ebnzov"
                ...
                <div class="brz-container brz-css-mlside brz-css-c2jm35">
                    <div id="" class="brz-css-s7nfl9 brz-css-pr4zg9 brz-wrapper">
                                    ...
                                    <form id="search-form" action="{{ route('search', ['lang' => app()->getLocale()]) }}" method="GET" class="search-form">
                                        <div class="dgwt-wcas-search-wrapp dgwt-wcas-is-detail-box dgwt-wcas-has-submit woocommerce dgwt-wcas-style-pirx js-dgwt-wcas-layout-classic dgwt-wcas-layout-classic">
                                            <div class="dgwt-wcas-sf-wrapp" style="position: relative;">
                                                ...
                                                <div id="search-suggestions" class="dgwt-wcas-suggestions-wrapp woocommerce" style="display: none; position: absolute; top: 100%; left: 0; right: 0; background: white; border: 1px solid #ddd; border-radius: 4px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); z-index: 1000; max-height: 400px; overflow-y: auto;">
                    ...
                    <div id="" class="brz-css-s7nfl9 brz-css-usssaz brz-wrapper">
                        <div class="brz-rich-text brz-rich-text__custom brz-css-18unjkp brz-css-nqedkh"
                             data-brz-custom-id="max307Qfusev">
                            <div data-brz-translate-text="1">
    ...
    @push('styles')
        <style>
            ...
            .dgwt-wcas-search-input:focus {
                ...
                box-shadow: 0 0 0 2px rgba(0, 116, 249, 0.1) !important;
            }
                ...
                if (races.length > 0) {
                    ...
                    races.forEach((race, index) => {
                        ...
                        if (query.length > 0) {
                            ...
                            highlightedText = escapeHtml(race.text).replace(regex, '<strong>$1</strong>');
                        }
